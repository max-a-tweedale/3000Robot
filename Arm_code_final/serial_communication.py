...
class arduinoController:
    ...
    def composeMessage(self, servoAngle_q1, servoAngle_q2, servoAngle_q3, servoAngle_EE=90, servo1_time = None, instruction="BUZZ", **kwargs):
        """
        --Description--
        ...
        if servo1_time is not None:
            servoTime1 = str(servo1_time)
        else:
